...
3.	Extraia a pasta ISO-Toolkit.AppDir para um local de sua preferência (Ex: ~/Portable/).
4.	No terminal dentro da pasta, execute: chmod +x *.sh AppRun.
5.	Execute o AppRun e use o botão  ⚙️ Configurações no rodapé para integrar o app ao seu sistema.
